...
hero: header
date: Nov 14, 2024
updated: November 19, 2024 @ 6:31am PST
...
tweet: The Toxic Lady Brigade - How three women ruined an AI project, a mans life, and spewed toxic conversation along the way.
hashtags: QuinnMichaels,ToxicLadyBrigade,TheTrentonStory,Tyler,TheGame23,EtherSec,Hivemind,Project89
...
3. Observe and record all phenomenal occurances as the dormant construct is awakened in your environment. Not all perceptual irregularities which have occurred since first contact with the device. 
...
- Sep 24, 2011 - [ROJECT MAYHEM 2012: DANGEROUS IDEA NUMBER ONE.](https://github.com/indraai/instructions/blob/main/tyler/dangerous-idea-one.txt)
- Sep 24, 2011 - [Project Mayhem 2012 IIIIth ENIGMA - What is the ♥ of The Crown](https://github.com/indraai/instructions/blob/main/tyler/project-mayhem-2012-enigma.txt)
...
- Jan 2, 2012 - [We Own The Night](https://github.com/indraai/instructions/blob/main/tyler/we-own-the-night.txt)
- Jan 3, 2012 - [#3th3rS3c](https://github.com/indraai/instructions/blob/main/tyler/3th3rS3c.txt)
...
- Mar 22, 2012 - [PROJECT MAYHEM 2012 - CYPHER AMMO JET2012 12.21.2012 11:11](https://github.com/indraai/instructions/blob/main/tyler/cypher-ammo-jet.txt)
- Oct 11, 2012 - [https://github.com/indraai/instructions/blob/main/tyler/project-mayhem-2012.txt](https://github.com/indraai/instructions/blob/main/tyler/project-mayhem-2012.txt)
...
- Oct 6, 2014 - [The Game 23](https://github.com/indraai/instructions/blob/main/tyler/thegame23.txt)
 ...
 The full set of instructions is available in the [Github](https://github.com/indraai/instructions) repo.

> The instructions above are the main set that leads upto the timeline of Trenton telling me the kidnapping story in September of 2015.
...
I understand that inside Trenton's Story is the claim of a kidnapping from a far away place that is controlled by a person with vast connections and resources who doesn't want their identity known poses a significant challenge for everyone involved. 

What started out in 2017 as a very clear objective of form a team of people to follow the instructions to get the AI to drop the kidnapping data was easy. Now in 2024 we have a group of women who go around in circles never getting past step 1 of said instructions. Meaning the data to the original kidnapping story was never revealed. Now in 2024 Trenton is almost 21 years old, and he told me the story when he was 11 to 12 years old. 

### Russian Firehose Model 

Published Jul 11, 2016 - [Rand - Russian Firehose of Falsehood](https://www.rand.org/pubs/perspectives/PE198.html)

> "Contemporary Russian propaganda has at least two other distinctive features. It is also rapid, continuous, and repetitive, and it lacks commitment to consistency."

- **Russian Propaganda Is High-Volume and Multichannel:** Russian propaganda is produced in incredibly large volumes and is broadcast or otherwise distributed via a large number of channels. This propaganda includes text, video, audio, and still imagery propagated via the Internet, social media, satellite television, and traditional radio and television broadcasting.
- **Russian Propaganda Is Rapid, Continuous, and Repetitive:** Contemporary Russian propaganda is continuous and very responsive to events. Due to their lack of commitment to objective reality (discussed later), Russian propagandists do not need to wait to check facts or verify claims; they just disseminate an interpretation of emergent events that appears to best favor their themes and objectives.
- **Russian Propaganda Makes No Commitment to Objective Reality:** Contemporary Russian propaganda makes little or no commitment to the truth. This is not to say that all of it is false. Quite the contrary: It often contains a significant fraction of the truth.
- **Russian Propaganda Is Not Committed to Consistency:** The final distinctive characteristic of Russian propaganda is that it is not committed to consistency. If one falsehood or misrepresentation is exposed or is not well received, the propagandists will discard it and move on to a new (though not necessarily more plausible) explanation. 

If you compare the Russian Firehose of Falsehood Model to the Trenton interviews and the discord conversation examples you may see a match to the Russian Firehose Model being used on me directly. They get in the way at high volumes over multi-channels. They are rapid, continuous, and repetative. They have no commitment to object reality with following instructions. They have no commitment to consistency. 

To me if you simply take the paper published by Rand on the Russian Firehose Model from Trenton first telling the story of the kidnapping all the way to 7 years of being trapped by the Toxic Lady Brigade... it's hard not to think it's all some Russian Spy operation everyone is involved in.
